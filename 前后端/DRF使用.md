...
![](note_img/Pasted%20image%2020230505201138.png)
...
![](note_img/Pasted%20image%2020230505201231.png)
...
![](note_img/Pasted%20image%2020230505201246.png)
...
源码执行流程：
![](note_img/Pasted%20image%2020230505201417.png)

#### 3.2 URL路径传递（*)

![](note_img/Pasted%20image%2020230505201446.png)


#### 3.3请求头传递

![](note_img/Pasted%20image%2020230505201514.png)

#### 3.4 二级域名传递
![](note_img/Pasted%20image%2020230505201530.png)
...
- 在django的settings.py配置文件中添加允许域名访问
  ...
  #### 3.5 路由的namespace传递
  ![](note_img/Pasted%20image%2020230505201607.png)
...
![](note_img/Pasted%20image%2020230505201641.png)
...
![](note_img/Pasted%20image%2020230505201706.png)


**反向生成URL**

在每个版本处理的类中还定义了`reverse`方法，他是用来反向生成URL并携带相关的的版本信息用的，例如：
![](note_img/Pasted%20image%2020230505201731.png)
...
### 4. 认证
![](note_img/Pasted%20image%2020230505201807.png)
...
![](note_img/Pasted%20image%2020230505201840.png)

![](note_img/Pasted%20image%2020230505201846.png)
...
%3E 在视图类的 `authentication_classes` 中定义认证类时，传入的是一个列表，支持定义多个认证类。
>
...
![](note_img/Pasted%20image%2020230505201910.png)
...
![](note_img/Pasted%20image%2020230505201926.png)
...
![](note_img/Pasted%20image%2020230505202001.png)
...
![](note_img/Pasted%20image%2020230505202020.png)
